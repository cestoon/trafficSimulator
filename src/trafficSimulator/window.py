...
class Window:
    def __init__(self, sim, config={}):
        ...
        self.traffic_flow_button = traffic_flow_button.Button(90, 20, self.plus_img, self.minus_img, 0.01, 0.01)
        self.vehicle_velocity_button = vehicle_velocity_button.Button(130, 40, self.plus_img, self.minus_img, 0.01, 0.01)
        self.light_2lane_button = scene_light_2lane_button.Button(230, 200, self.light_2lane_img, 0.45,2,40,90)
        self.smart_2lane_button = scence_smart_2lane_button.Button(430, 200, self.smart_2lane_img, 0.45,2,40,90)
        self.unbalance_smart = unbalance_smart.Button(430, 140, self.unbalance_smart_img, 0.45,2,40,90)
        self.unbalance_traffic = unbalance_traffic.Button(230, 140, self.unbalance_traffic_img, 0.45,2,40,90)
        self.traffic_long_buffer = classical_long_buffer_btn.Button(170, 200, self.classical_long_buffer_img, 0.45,2,80,50)
        self.traffic_short_buffer = classical_short_buffer_btn.Button(290,200, self.classical_short_buffer_img, 0.45,2,20,110)
        self.smart_long_buffer = smart_long_buffer_btn.Button(370, 200, self.smart_long_buffer_img, 0.45,2,80,50)
        self.smart_short_buffer = smart_short_buffer_btn.Button(490, 200, self.smart_short_buffer_img, 0.45,2,20,110)
        self.unbalance_large_traffic = unbalance_large_traffic_btn.Button(170, 140, self.unbalance_large_traffic_img, 0.45,2,40,90)
        self.unbalance_large_smart = unbalance_large_smart_btn.Button(370, 140, self.unbalance_large_smart_img, 0.45,2,40,90)
        self.balance_smart = balance_smart_btn.Button(490, 140, self.balance_smart_btn_img,0.45,2,40,90)
        self.balance_traffic = balance_traffic_btn.Button(290, 140, self.balance_traffic_btn_img, 0.45,2,40,90)
        self.with_traffic_ight = balance_traffic_btn.Button(150, 70, self.with_traffic_ight_img, 0.45,2,40,90)
        self.without_traffic_light = balance_traffic_btn.Button(350, 70, self.without_traffic_light_img, 0.45,2,40,90)
        self.buffer_area_length = balance_traffic_btn.Button(10, 200, self.buffer_area_length_img, 0.45,2,40,90)
        self.traffic_flow_distence = balance_traffic_btn.Button(10, 140, self.traffic_flow_distence_img, 0.45,2,40,90)
