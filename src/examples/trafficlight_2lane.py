...
def traffic_light_2lane():
    ...
    sim.paths = [
        ...
        },
        {
            'id': 8,
            'weight': 1,
            'roads': [2, *road(12 + 4 * n), 7]
        },
        {
            'id': 9,
            'weight': 1,
            'roads': [2, *road(12 + 5 * n), 5]
        },
        {
            'id': 10,
            'weight': 3,
        ...
        },
        {
            'id': 11,
            'weight': 1,
            'roads': [3, *road(12 + 6 * n), 4]
        },
        {
            'id': 12,
            'weight': 1,
            'roads': [3, *road(12 + 7 * n), 6]
        }
    ]
...
if __name__ == '__main__':
    # Start simulation
    win = Window(traffic_light_2lane())
    win.zoom = 10
