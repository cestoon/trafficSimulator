    ...
    sim.paths = [
        {
            'id': 1,
            'weight': 2,
            'roads': [0, *road(12), *road(12 + 4 * n), 10, 6]
        },
        {
            'id': 2,
            'weight': 1,
        ...
        },
        {
            'id': 3,
            'weight': 1,
            'roads': [0, *road(12), *road(12 + 4 * n), *road(12 + 5 * n), 11, 7]
        },
        {
            'id': 4,
            'weight': 2,
            'roads': [1, *road(12 + n), *road(12 + 5 * n), 11, 7]
        },
        {
            'id': 5,
            'weight': 1,
            'roads': [1, *road(12 + n), 10, 6]
        },
        {
            'id': 6,
            'weight': 1,
            'roads': [1, *road(12 + n), *road(12 + 5 * n), *road(12 + 6 * n), 8, 4]
        },
        {
            'id': 7,
            'weight': 2,
            'roads': [2, *road(12 + 2 * n), *road(12 + 6 * n), 8, 4]
        },
        {
            'id': 8,
            'weight': 1,
            'roads': [2, *road(12 + 2 * n), 11, 7]
        },
        {
            'id': 9,
            'weight': 1,
            'roads': [2, *road(12 + 2 * n), *road(12 + 6 * n), *road(12 + 7 * n), 9, 5]
        },
        {
            'id': 10,
            'weight': 2,
            'roads': [3, *road(12 + 3 * n), *road(12 + 7 * n), 9, 5]
        },
        {
            'id': 11,
            'weight': 1,
            'roads': [3, *road(12 + 3 * n), 8, 4]
        },
        {
            'id': 12,
            'weight': 1,
            'roads': [3, *road(12 + 3 * n), *road(12 + 7 * n), *road(12 + 4 * n), 10, 6]
        },
    ]
