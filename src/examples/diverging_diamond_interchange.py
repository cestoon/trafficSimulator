...
sim.paths = [
    ...
    },
    {
        'id': 5,
        'weight': 5,
        'roads': [1, 23, *road(26 + 12 * n), 9]
    },
    {
        'id': 6,
        'weight': 3,
        'roads': [1, 23, *road(26 + 13 * n), 16, *road(26 + 2 * n), 14, 15, *road(26 + 3 * n), 11]
    },
    {
        'id': 7,
        'weight': 1,
        'roads': [1, 23, *road(26 + 13 * n), 16, *road(26 + 15 * n), 25, 7]
    },
    {
        'id': 8,
        'weight': 2,
        'roads': [8, *road(26 + 4 * n), 22, 3]
    },
    {
        'id': 9,
        'weight': 4,
        'roads': [8, *road(26), 12, 13, *road(26 + n), 16, *road(26 + 2 * n), 14, 15, *road(26 + 3 * n), 11]
    },
    {
        'id': 10,
        'weight': 2,
        'roads': [8, *road(26), 12, 13, *road(26 + n), 16, *road(26 + 15 * n), 25, 7]
    },
    {
        'id': 11,
        'weight': 5,
        'roads': [5, 24, *road(26 + 6 * n), 11]
    },
    {
        'id': 12,
        'weight': 3,
        'roads': [5, 24, *road(26 + 7 * n), 21, *road(26 + 9 * n), 20, 19, *road(26 + 8 * n), 9]
    },
    {
        'id': 13,
        'weight': 1,
        'roads': [5, 24, *road(26 + 7 * n), 21, *road(26 + 5 * n), 22, 3]
    },
    {
        'id': 14,
        'weight': 2,
        'roads': [10, *road(26 + 14 * n), 25, 7]
    },
    {
        'id': 15,
        'weight': 4,
        'roads': [10, *road(26 + 11 * n), 17, 18, *road(26 + 10 * n), 21, *road(26 + 9 * n), 20, 19, *road(26 + 8 * n),
                  9]
    },
    {
        'id': 16,
        'weight': 2,
        'roads': [10, *road(26 + 11 * n), 17, 18, *road(26 + 10 * n), 21, *road(26 + 5 * n), 22, 3]
    },
]
# Start simulation
win = Window(sim)
